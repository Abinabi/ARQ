...
void computer()                                    // to draw the sender and receiver computers
{
    ...
    glColor3f(0.0,0.0,1.0);//vertical stand
    glBegin(GL_LINES);
        glVertex2f(105,380);
        glVertex2f(105,375);
        glVertex2f(129,380);
    ...
    glColor3f(0.0,0.3,1.0); //horizontal stand
    glBegin(GL_QUADS);
        glVertex2f(98,370);
        glVertex2f(98,375);
        glVertex2f(138,375);
    ...
    glColor3f(0.7,0.2,1.0);//keyboard outline
    glBegin(GL_LINE_LOOP);
        glVertex2f(77,325);
        glVertex2f(87,350);
        glVertex2f(148,350);
    ...
    glColor3f(0.7,0.7,1.0); //horizontal lines of keyboard
    glBegin(GL_LINES);
        glVertex2f(85,345);
        glVertex2f(150,345);
        glVertex2f(83,340);
    ...
    glColor3f(0.7,0.7,1.0); //vertical lines of keyboard
    glBegin(GL_LINES);
        glVertex2f(89,322);
        glVertex2f(97,350);
        glVertex2f(103,322);
    ...
    glColor3f(1.0,1.0,1.0);//connectin wire
    glBegin(GL_LINES);
        glVertex2f(155,360);
        glVertex2f(330,360);
    glEnd();
...
void slide(GLint maxx,GLint maxy,GLfloat x0,GLfloat y0) // TO DRAW WINDOWS (Rectangular Mesh)s
{
    for(i=0;i<maxx;i++)
        x[i]=x0+i*dx;
...
void timer0()
{
    ...
    glBegin(GL_LINE_LOOP);
        glVertex2f(100,120);
        glVertex2f(100,130);            //timer for frame0
        glVertex2f(225, 130);
        glVertex2f(225, 120);
    glEnd();
    glFlush();
...
void timer1()
{
    ...
    glBegin(GL_LINE_LOOP);
        glVertex2f(100, 100);
        glVertex2f(100, 110);
        glVertex2f(225, 110);               //timer for frame1
        glVertex2f(225, 100);
    glEnd();
    glFlush();
}
void timer2()
{
    ...
    glBegin(GL_LINE_LOOP);
        glVertex2f(100,80);
        glVertex2f(100,90);             //timer for frame2
        glVertex2f(225,90);
        glVertex2f(225,80);
    glEnd();
    glFlush();
...
void timer3()
{
    ...
    glBegin(GL_LINE_LOOP);
        glVertex2f(360, 120);
        glVertex2f(360, 130);           //timer for frame3
        glVertex2f(485, 130);
        glVertex2f(485, 120);
    glEnd();
    glFlush();
...
void timer4()
{
    ...
    glBegin(GL_LINE_LOOP);
        glVertex2f(360, 100);
        glVertex2f(360, 110);                //timer for frame4
        glVertex2f(485, 110);
        glVertex2f(485, 100);
    glEnd();
    glFlush();
...

{
    ...
    glColor3f(1.0f,1.0f,1.0f);
    setFont(GLUT_BITMAP_HELVETICA_18);
    drawstring(360.0,130.0,1.0,"PRESS : YES / NO");
    glColor3f(1.0f,1.0f,1.0f);
    drawstring(360.0,110.0,1.0,"TO CONTINUE THE PROCESS");
    glFlush();
}
